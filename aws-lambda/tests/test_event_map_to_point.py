...
def test_event_map_to_point_latがfloatでないならNoneを返す():
    assert lambdasrc.lambda_function.event_map_to_point({'lat':'abcd','lon':132.71309945650137}) == None
    assert lambdasrc.lambda_function.event_map_to_point({'lat':34,'lon':132.71309945650137}) == None

def test_event_map_to_point_lonがfloatでないならNoneを返す():
    assert lambdasrc.lambda_function.event_map_to_point({'lat':34.40094244423058,'lon':'132.71309945650137'}) == None
    assert lambdasrc.lambda_function.event_map_to_point({'lat':34.40094244423058,'lon':132}) == None
